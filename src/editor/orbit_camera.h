...
public:
    ...
    void reset() { yaw = pitch = 0.f; distance = defaultDistance; }
    ...
    void view(float (&out)[3][4]) const {
        ...
        out[0][0]=cy; out[0][1]=0; out[0][2]=-sy; out[0][3]=0;
        out[1][0]=-sp*sy; out[1][1]=cp; out[1][2]=-sp*cy; out[1][3]=0;
        out[2][0]=cp*sy; out[2][1]=sp; out[2][2]=cp*cy; out[2][3]=-distance;
    }
};
