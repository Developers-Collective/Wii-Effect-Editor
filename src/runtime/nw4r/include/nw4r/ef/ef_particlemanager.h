...
class ParticleManager : public ReferencedObject {
  ...
  public:
    ...
    virtual Particle* CreateParticle(u16 life, math::VEC3 pos, math::VEC3 vel, const math::MTX34* pSpace, f32 momentum,
                                     const EmitterInheritSetting* pSetting, Particle* pReferencePtcl,
    ...
    void Modifier_SetSimpleLightParameter(const EmitterDrawSetting& rSetting) {
        Modifier_SetSimpleLightParameter(rSetting.mLighting.mType, rSetting.mLighting.mAmbient,
                                         rSetting.mLighting.mDiffuse, rSetting.mLighting.mRadius,
                                         rSetting.mLighting.mPosition);
    }

    void Modifier_SetSimpleLightParameter(u8 type, const GXColor& rAmbient, const GXColor& rDiffuse, f32 radius,
    ...
    static void ModifierTravFunc_SetSimpleLightType(void* pObject, ForEachParam param) {
        ...
        static_cast<ParticleManager*>(pObject)->mModifier.mLight.mType = static_cast<u8>(param);
    }

    static void ModifierTravFunc_SetSimpleLightAmbient(void* pObject, ForEachParam param) {

        static_cast<ParticleManager*>(pObject)->mModifier.mLight.mAmbient = *reinterpret_cast<GXColor*>(param);
    }

    static void ModifierTravFunc_SetScale(void* pObject, ForEachParam param) {
        static_cast<ParticleManager*>(pObject)->mModifier.mScale = *reinterpret_cast<math::VEC2*>(param);
    }

    static void ModifierTravFunc_SetRotate(void* pObject, ForEachParam param) {
        static_cast<ParticleManager*>(pObject)->mModifier.mRotate = *reinterpret_cast<math::VEC3*>(param);
    }
};
